...
if [[ "$1" == "00" ]]; then
    run_miner 0 0 34.27.106.110 30000

elif [[ "$1" == "01" ]]; then
    run_miner 0 1 34.27.106.110 30001

elif [[ "$1" == "02" ]]; then
    run_miner 0 2 34.27.106.110 30002

elif [[ "$1" == "10" ]]; then
    run_miner 1 0 34.27.106.110 30003

elif [[ "$1" == "11" ]]; then
    run_miner 0 1 34.27.106.110 30004

elif [[ "$1" == "12" ]]; then
    run_miner 0 2 34.68.118.43 30005

elif [[ "$1" == "20" ]]; then
    run_miner 2 0 34.68.118.43 30006

elif [[ "$1" == "21" ]]; then
    run_miner 0 1 34.68.118.43 30007

elif [[ "$1" == "22" ]]; then
    run_miner 0 2 34.68.118.43 30008
